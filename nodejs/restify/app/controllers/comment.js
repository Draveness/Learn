...
exports.updateComment = function(req, res, next) {
	...
	Article.update(
			...
			{"$sets": {"comments.$.text": updatedCommentModel.text, "comments.$.author": updatedCommentModel.author}},
			function(err) {
				if (err) {
					res.status(500);
					res.json({
...
exports.deleteComment = function(req, res, next) {
	Article.findByOneAndUpdate({"comments._id": new ObjectId(req.params.id)},
