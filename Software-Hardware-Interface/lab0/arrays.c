...
int main(int argc, char* argv[]) {
  ...
  // testing.
  // Answer: the function still succeed, and place value 
  // correctly.
  fillArray(array, 10);
  ...
  // Answer: because the parameter pass into the function is
  // an address, &value is an address, so it is possible to
  // fill the value variable.
  fillArray(&value, 1);
  ...
  // C++ programming.
  // Answer: there is a memory leak problem.
  free(heap_array);
